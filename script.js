function initButtons() {
    ...
    noBtn.addEventListener('mouseenter', () => {
        ...
        if (title) {
            ...
            if (gif.complete && gif.naturalWidth) setPositionUsingNatural();
            else gif.onload = setPositionUsingNatural;
        }
    ...
    // ===== MOBILE TAP: simulate hover =====
    noBtn.addEventListener('touchstart', e => {
        e.preventDefault();
        noBtn.dispatchEvent(new Event('mouseenter'));
    }, { passive: false });

    // ===== BLOCK click/mousedown on No button =====
